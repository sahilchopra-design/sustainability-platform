    ...
    <div className="min-h-screen bg-gray-50 dark:bg-white">
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-7 h-auto p-1 bg-gray-50 dark:bg-white rounded-lg">
            <TabsTrigger 
              value="dashboard" 
              className="flex items-center gap-2 py-2.5 data-[state=active]:bg-white dark:data-[state=active]:bg-[#1a2234]"
          ...
          <TabsContent value="just-transition" className="space-y-6">
            <div className="p-1">
              <h2 className="text-base font-semibold text-gray-800 mb-1">Just Transition Calculator</h2>
              <p className="text-xs text-gray-500 mb-4">ILO Just Transition Guidelines · IRENA WETO 2023 · World Bank JT Framework — Employment, social cost and financing gap analysis</p>
              <JustTransitionPanel />
            </div>
          </TabsContent>
          ...
          <TabsContent value="etm" className="space-y-6">
            <div className="p-1">
              <h2 className="text-base font-semibold text-gray-800 mb-1">Energy Transition Mechanism (ETM)</h2>
              <p className="text-xs text-gray-500 mb-4">ADB/AIIB/Citi ETM Framework 2022 — Early coal plant retirement via concessional debt buyout and blended finance structure</p>
              <ETMPanel />
            </div>
          </TabsContent>
        </Tabs>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Counterparty</th>
                    <th className="text-center py-3 px-4 text-sm font-medium text-gray-500">Risk</th>
                    <th className="text-right py-3 px-4 text-sm font-medium text-gray-500">Impact</th>
                    <th className="text-center py-3 px-4 text-sm font-medium text-gray-500">Time</th>
                    <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {data.alerts.map((alert) => (
                    <tr key={alert.alert_id} className="border-b hover:bg-gray-50 dark:hover:bg-white">
                      <td className="py-3 px-4">
                        <p className="font-medium">{alert.asset_name}</p>
                        <p className="text-xs text-gray-500">{alert.alert_trigger}</p>
                      </td>
                      <td className="py-3 px-4">
