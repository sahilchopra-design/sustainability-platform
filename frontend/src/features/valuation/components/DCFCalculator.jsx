              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 text-center">
                    <p className="text-xs text-gray-600 font-medium">Avg Cash-on-Cash</p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-right py-2 px-3 font-medium text-gray-600">NOI</th>
                    <th className="text-right py-2 px-3 font-medium text-gray-600">Debt Service</th>
                    <th className="text-right py-2 px-3 font-medium text-gray-600">CFADS</th>
              ...
              <div className="space-y-2">
                {Object.entries(result.sensitivity_cap_rate).map(([rate, value]) => (
                  <div key={rate} className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">{(parseFloat(rate) * 100).toFixed(1)}%</span>
