...
export const RiskSliders = ({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-6" data-testid="risk-sliders">
      {/* Risk Parameters */}
      <div>
        <h4 className="text-sm font-semibold text-gray-900 mb-4">Risk Parameters</h4>
      ...
      <div>
        <h4 className="text-sm font-semibold text-gray-900 mb-4">Price & Financial</h4>
        <div className="space-y-6">
      ...
      <div className="border-t border-gray-200 pt-4">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-gray-600">Total Risk Adjustment</span>
        ...
        <div className="mt-2 h-2 bg-gray-50 rounded-full overflow-hidden">
          <div
